...
namespace Drupal\xtc\PluginManager\XtcSearch;
 ...
 * @endcode
 *
 * @see \Drupal\xtc\XtcSearchDefault
 * @see \Drupal\xtc\XtcSearchInterface
 * @see plugin_api
 */
class XtcSearchPluginManager extends DefaultPluginManager {
  ...
  protected $defaults = [
    ...
    'class' => 'Drupal\xtc\XtcSearchDefault',
  ];
  ...
  public function __construct(ModuleHandlerInterface $module_handler, CacheBackendInterface $cache_backend) {
    ...
    $this->alterInfo('xtc_search_info');
    $this->setCacheBackend($cache_backend, 'xtc_search_plugins');
  }
